        ...
        <div class="container">
            ...
            <ul class="layui-nav left fast-add" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a onclick="xadmin.add_tab('在tab打开','member-list.html',true)">
            ...
            <ul class="layui-nav right" lay-filter="">
                ...
                <li class="layui-nav-item to-index">
                    <a href="javascript:alert('aa')">技术支持</a></li>
            </ul>
        </div>
        <!-- 顶部结束 -->
        <!-- 中部开始 -->
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('客户列表','member-list.php',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>客户列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('在线设备列表','device-list.html',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>在线设备列表</cite></a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('设备在线数','echarts1.html',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>设备在线数</cite></a>
                            </li>
                        </ul>
